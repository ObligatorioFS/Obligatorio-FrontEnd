...
const Registro = () => {
  ...
  const handleOnClickRegistro = (data) => {
     const usuario = { ...data }
     delete usuario.confirmarPassword //para no mandar el campo de confirmar password al backend
    setCargando(true);
  ...
  return (
    <main className="auth-layout">
      <section className="auth-card register-card">
        <form
          onSubmit={handleSubmit(handleOnClickRegistro)}
          className="auth-form"
        >
          ...
          <label>
            ...
            <MensajeError mensaje={errors.confirmarPassword?.message} />
          </label>

          <button disabled={cargando} className="primary-btn" type="submit">
